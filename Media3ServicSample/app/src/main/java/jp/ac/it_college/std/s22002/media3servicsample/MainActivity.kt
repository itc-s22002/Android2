package jp.ac.it_college.std.s22002.media3servicsample
...
import jp.ac.it_college.std.s22002.media3servicsample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun playSample(){
        ...
        controller.setMediaItem(
            MediaItem.fromUri("android.resource//${packageName}/${R.raw.sample}")
        )
